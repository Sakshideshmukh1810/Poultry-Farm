...
{
    public partial class Productbilling : Form
    {
        User db = new User();
        string id;
        String fname;
        ...
        private void Productbilling_Load(object sender, EventArgs e)
        {
            db.FillGridData(dg, "Select *from Billing");
            btnnew.Focus();
            EnabledFales();
        }
        ...
        private void btncust_Click(object sender, EventArgs e)
        {
            //Open Customer Form
            f = new custentry();
            f.custgridv.Click += new EventHandler(dg1_Click);
            f.Show();
        }
        ...
        void Griddisplay()
        {
            try
            {
                txtno.Text = dg.SelectedRows[0].Cells["BillNo"].Value.ToString();
                txtname.Text = dg.SelectedRows[0].Cells["CustName"].Value.ToString();
                txtcustno.Text = dg.SelectedRows[0].Cells["CustNo"].Value.ToString();
                txtamt.Text = dg.SelectedRows[0].Cells["BillAmt"].Value.ToString();
                txtdiscp.Text = dg.SelectedRows[0].Cells["DiscountP"].Value.ToString();
                txtdiscamt.Text = dg.SelectedRows[0].Cells["Discount"].Value.ToString();
                txtnet.Text = dg.SelectedRows[0].Cells["NetAmt"].Value.ToString();
                txtfdate.Value = DateTime.Parse(dg.SelectedRows[0].Cells["BillDate"].Value.ToString());
                EnabledFales();
        ...
        void GetmaxID()
        {
            txtno.Text = db.GetAutoId("Select Max(BillNo) from Billing").ToString();
        }
