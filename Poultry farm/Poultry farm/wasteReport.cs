...
{
    public partial class wasteReport : Form
    {
        public wasteReport()
        {
            InitializeComponent();
        ...
        {
            wastematerial ws = new wastematerial();
            Poultry psPoultry = GetData();
            ws.SetDataSource(psPoultry);
            this.crystalReportViewer1.ReportSource = ws;
        ...
        private Poultry GetData()
        {
            ...
            {
                using (SqlCommand cmd = new SqlCommand("select * from tblwastesale "))
                {
                    using (SqlDataAdapter sda = new SqlDataAdapter())
                    {
                        ...
                        {
                            sda.Fill(psPoultry, "tblwastesale");
                            return psPoultry;
                        }
                    }
                }
